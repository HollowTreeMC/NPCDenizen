    ...
    steps:
        ...
        2:
            click trigger:
                ...
                - wait 2s
                - narrate "<server.flag[pfx_cogsworth]><&f> Make a <&hover[<&6>Be near a Crafter when it crafts a Crafter]><&6>crafter craft a crafter<&end_hover><&f>!"
                - zap 3
        ...
        3:
            click trigger:
                ...
                - if <player.has_advancement[minecraft:adventure/crafters_crafting_crafters]>:
                    ...
                    - zap 4
                - else:
                    - narrate "<server.flag[pfx_cogsworth]><&f> <player.name>, how would a <&hover[<&6>Be near a Crafter when it crafts a Crafter]><&6>crafter craft a crafter<&end_hover><&f>?"
        ...
        4:
            click trigger:
                ...
                - else:
                    - narrate "<server.flag[pfx_cogsworth]><&f> Come, let me take you into my employ <&hover[<&6>Become a Tinkerer]><&8><element[[Yes]].on_click[/denizenclickable chat Yes]><&end_hover>"
