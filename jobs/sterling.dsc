    ...
    steps:
        ...
        2:
            click trigger:
                ...
                - narrate "<server.flag[pfx_sterling]><&f> Who's there? We need more hands at the forge, <&hover[<&6>Craft an Iron Chestplate]><&6>forge an iron chestplate<&end_hover><&f> to prove your mettle."
                - zap 3
        ...
        3:
            click trigger:
                ...
                - if <player.has_advancement[minecraft:story/obtain_armor]>:
                    ...
                    - zap 4
                - else:
                    - narrate "<server.flag[pfx_sterling]><&f> Come back once you've <&hover[<&6>Craft an Iron Chestplate]><&6>forged a chestplate<&end_hover><&f>..."
        ...
        4:
            click trigger:
                ...
                - else:
                    - narrate "<server.flag[pfx_sterling]><&f> Would you like to join the core and work as a Smith? <&hover[<&6>Become a Smith]><&8><element[[Yes]].on_click[/denizenclickable chat Yes]><&end_hover>"
