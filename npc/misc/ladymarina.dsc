      ...
      1:
        ...
        click trigger:
            ...
            - if <player.flag[countboxes]> == 1:
                ...
                - wait 3s
                - narrate "<[pfx_ladymarina]><&f>For future reference, I can take multiple shulker boxes at a time."
                - wait 3s
                - narrate "<[pfx_ladymarina]><&f>To trade it, hold it in your hand and say yes. <&nl><bold>Click or Say:<reset><&nl><&sp><&sp><&sp><aqua>[<green><element[Yes].on_click[/denizenclickable chat yes]><aqua>]<reset>"
                - wait 3s
            ...
            - if <player.flag[countboxes]> > 1:
                ...
                - wait 3s
                - narrate "<[pfx_ladymarina]><&f>I can take every shulker box in your inventory or just one."
                - wait 3s
                - narrate "<[pfx_ladymarina]><&f>Just say one or all to trade them. <&nl><bold>Click or Say:<reset><&nl><&sp><&sp><&sp><aqua>[<green><element[All].on_click[/denizenclickable chat all]><aqua>]<reset> or <aqua>[<green><element[One].on_click[/denizenclickable chat one]><aqua>]<reset>"
                - wait 3s
                - narrate "<dark_aqua>[<aqua>!]<dark_aqua> <gray>Marina found <player.flag[countboxes]> Shulker boxes to sell!"
                - flag player countboxes:!
                - flag player npcBusy:!
