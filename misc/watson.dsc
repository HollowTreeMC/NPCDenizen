    ...
    steps:
        1:
            click trigger:
                ...
                - wait 3
                - narrate "<server.flag[pfx_watson]><&f> I'd be shocked if you weren't here to a purchase a book. I have many novels available. Would you like to take a look? <server.flag[npc_dialouge_yesno]>"
