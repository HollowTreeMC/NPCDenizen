            ...
            click trigger:
                ...
                - else:
                    ...
                    - if <player.has_permission[group.chronarch]> || <player.money> > 1000000:
                        ...
                        - wait 2
                        - narrate "<server.flag[pfx_ladyvalvewright]><&f> Would like to purchase a pass? For 5,000 coins, you can purchase a 1-week pass! \n<&8><&o>Respond with: <&hover[<&6>Purchase Pass]><&8><element[[Yes]].on_click[/denizenclickable chat Yes]><&end_hover> <&hover[Do not purchase]><&8><element[[No]].on_click[/denizenclickable chat No]><&end_hover>"
